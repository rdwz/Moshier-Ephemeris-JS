...
3) Calculating retrograde and direct moments / stations is performed down to the second and will return consistent results each time. It should be noted that this calculation is largely an impression and an estimate by any method due to the apparent nature of what it means for a celestial body to be retrograde / stationary from a geocentric perspective. According to the strictest definitions of when a station begins and ends, these calculations were performed with consistency in mind rather than pinpoint accuracy. I found a small, reproducable, yet wholly unexpected abnormality in the moshier calculations when performing them on a second by second basis - which I won't get into here (but feel free to message me) - that lead me to add this note. Still, compared to other calculations you'll find on the internet, these results are in my opinion just as accurate if not more precise due to their consistency. 
